...
const etheriumContract: OmniPointHardhat = {
...
const pathways: TwoWayConfig[] = [
    [
        ...
        etheriumContract, // Chain B contract
    ...
    [
        etheriumContract, // Chain A contract
        polygonContract, // Chain B contract
        [['LayerZero Labs'], []], // [ requiredDVN[], [ optionalDVN[], threshold ] ]
        [1, 1], // [A to B confirmations, B to A confirmations]
        [EVM_ENFORCED_OPTIONS, EVM_ENFORCED_OPTIONS], // Chain B enforcedOptions, Chain A enforcedOptions
...
export default async function () {
    ...
    return {
        contracts: [{ contract: bscContract },{ contract: etheriumContract},{ contract: polygonContract }],
        connections,
    }
}
